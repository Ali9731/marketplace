...
return [
    'card_not_found' => 'شماره کارت وارد شده در سیستم موجود نمیباشد : :CARD',
    ...
    'agent_have_active_report' => 'شما یک تاخیر بررسی نشده دارید',
    'agent_id.required' => 'فیلد ای دی پشتیبان اجباری میباشد',
    'order_id.required' => 'فیلد ای دی سفارش اجباری میباشد',
